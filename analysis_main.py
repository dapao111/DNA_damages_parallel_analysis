...
from AnalysisBases import TopN_genes_age_tissue_correlation_analysis,TopN_genes_correlation_analysis,parallel_100_iters_results,print_ROC_result,calculate_confidencial_interval
...
parser.add_argument("-n", "--feature_num", help = "selected_Top_num_genes", required=False,default=500)
...
def ana_pipeline():
    ...
    for y_label in [y_age,y_tissue]:
        save_selected_data_metrics_flag = 0
